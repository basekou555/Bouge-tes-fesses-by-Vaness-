...
2. **Le mercato, dossier par dossier** : un joueur à la fois, jamais une liste à fouiller. Sa carte, et sous elle exactement ce qu'il faut pour trancher — ton budget, ta masse salariale et son plafond, ta place dans l'effectif, le quota d'étrangers, **les joueurs que tu as déjà à son poste** avec leur niveau et leur salaire, et s'il manque quelque chose, **qui vendre pour le faire entrer** (proposé seulement si la vente comble vraiment l'écart). Trois gestes : précédent, recruter, passer. Les dossiers faisables passent en premier, les hors de portée en dernier. Vends, recrute des stars si ta crédibilité le permet, des pros, des pépites venues d'une vidéo ou d'un cousin (certaines sont des arnaques), des joueurs libres ou des jeunes du centre.
...
4. **Tu ne composes pas, tu tranches.** L'adjoint aligne l'équipe et le calendrier se déroule seul. Il s'arrête sept à huit fois par saison, sur un **rendez-vous** : un cadre est blessé (le remplaçant sûr, le jeune jamais lancé, le faire jouer sur une jambe, ou laisser l'adjoint décider) · le capitaine plaide pour un joueur qui ne joue plus · le président veut voir jouer son plus gros salaire · le groupe est à bout · l'adversaire joue de telle manière · championnat ou coupe d'Europe. Tu décides, **le match se joue aussitôt**, et son résultat est la réponse à ta décision. Chaque choix a un prix immédiat et souvent une suite : lancer le jeune, c'est vexer le vétéran ; le faire jouer blessé, c'est 45 % de rechute aggravée.
...
**📊 Le tableau de bord**, accessible à tout moment depuis le bandeau, montre d'où vient chaque dixième de point : la force de ton équipe y est décomposée ligne par ligne — l'effectif, ta tactique, le vestiaire, le staff, le style, l'entraînement de la semaine, la dynamique, l'écho de la roulette — avec le calcul en clair (« Tactique 48 : chaque point au-dessus de 50 vaut 0,05 »). On y trouve aussi les semaines passées sur chaque entraînement, ce que chaque jeune a gagné à la dernière intersaison, tes quatre indicateurs, les cinq jauges et le réglage du rythme. Le mode joueur·euse a le sien : ta note face à tes concurrents, tes chances d'être titulaire, la confiance du coach, la forme.

**Un carrefour par phase** : chaque quart de saison s'ouvre sur une situation qui demande une décision — et une seule. Elle peut être un dilemme (une jauge au plus bas réclame une réponse), un incident, une affaire hors du terrain, ou un **carrefour d'énergie** : la reprise, le stage de présaison, la trêve de décembre, le sprint final. Là, trois chantiers sont posés sur la table — le terrain, le vestiaire, le centre, le club et les médias, tes proches — et un seul reçoit ton trimestre ; les deux autres reculent, et l'écran l'annonce avant que tu cliques. Tout sort du même sac : plus aucun écran de réglages ne tombe du ciel. Un chantier déjà solide progresse moins qu'un chantier négligé, et un chantier abandonné ne tombe pas à zéro : il s'installe dans la médiocrité. Il n'existe donc pas de saison parfaite, seulement des priorités assumées.

**Quarante situations par mode** : vingt affaires hors du terrain (le livre, le documentaire, le dossier anonyme, la politique, le proche hospitalisé…), vingt dilemmes qui ne se déclenchent que quand la jauge concernée est au plus bas, plus les incidents de saison et les carrefours. Une même situation ne revient jamais deux fois de suite.
...
**Aucun choix n'est gratuit, et aucun ne se prend à l'aveugle** : chaque option annonce la valeur actuelle de ce qu'elle touche et celle qu'elle donnerait — « 🏡 Proches 62 → 54 », « 🌡️ Pression 13 → 18 » — et un tableau « Où tu en es » récapitule sous les choix l'état de chaque indicateur concerné. Tu sais donc si tes proches sont déjà au plus haut ou au plus bas avant de trancher. Les chiffres affichés sont ceux qui seront appliqués : l'écran et le moteur partagent la même fonction de calcul, et la simulation le vérifie à chaque exécution. Et certains choix ne se paient pas tout de suite — ils reviennent deux ou trois saisons plus tard, en bien ou en mal : le livre qui vexe un futur dirigeant, l'adjoint parti se former qui revient grandi, le silence sur une affaire de paris qui ressort.
