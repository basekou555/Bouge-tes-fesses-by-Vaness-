...
4. **Le rythme** : tu ne joues pas la saison entière. « Temps forts » (par défaut) t'arrête à la reprise de chaque phase, puis sur les **deux** matchs qui comptent vraiment — chaque rencontre reçoit une note d'intérêt (sommet du championnat, match de la peur, choc contre le podium, concurrent direct, dernière journée) et seules les plus hautes passent, la barre s'abaissant si la phase s'achève sans rien d'énorme. Environ **dix matchs par saison**. « Complet » joue les 34, « Rapide » n'en garde que 4. Les autres se jouent en coulisses avec ta compo et tes réglages, et apparaissent en résumé.
